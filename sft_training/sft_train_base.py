...
def main():
    ...
    parser.add_argument('--output-dir', type=str, default='./checkpoints/llada_sft_frompretrain_FINAL', help='Directory to save checkpoints and logs.')
    ...
    parser.add_argument('--sft-lora-weights', type=str, default="/home/hice1/qfitterey3/scratch/LLada-Reasoning/checkpoints/llada_sft_frompretrain_FINAL/step-500/sft_adapter", help="Optional: Path to trainable LoRA weights from a previous SFT run to continue training.")
    parser.add_argument('--resume-from-checkpoint', type=str, default="/home/hice1/qfitterey3/scratch/LLada-Reasoning/checkpoints/llada_sft_frompretrain_FINAL/step-500", help="Path to resume trainer state (optimizer, scheduler, step).")
